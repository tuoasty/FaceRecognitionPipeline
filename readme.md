...
python AdaFace\inference\segment_dataset.py --input_dir output\v2\probe_labeled\positive --metadata_file output\v2\probe_labeled\probe_positive_metadata.json --output_dir output\v2\probe_labeled\segmented
...
To match
python AdaFace\inference\face_matcher.py --gallery_path AdaFace\inference\gallery\adaface_ir101_2.pkl --model_type adaface --architecture ir_101 --single_image AdaFace\inference\samples\random\606_1.jpg
To label
...
python face_recognition_client.py --server http://10.22.78.202:5000
python face_recognition_client.py --server http://10.22.224.73:5000 --session_name docker_test_1
python face_recognition_client.py --server http://127.0.0.1:5000 --session_name local_tenveo_test_1 --camera 1
python face_recognition_client.py --server http://10.22.65.73:5000 --session_name kube_test_727_3

http://10.22.78.202:5000

python AdaFace\inference\embedding_generator.py --dataset_root dataset --output_root output\v2 --model_type adaface --architecture ir_101